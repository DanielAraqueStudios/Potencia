...
\textbf{Datos:} $V_f=25(a+b+c)=25(3+9+3)=375\,\text{V}$ (tensión línea-línea rms),
$f=60{,}0\,\text{Hz}$, $R=8(a+b)=8(12)=96{,}0\,\Omega$, $L=(2b+c)=(18+3)=21{,}0\,\text{mH}$.

\subsection{Procedimiento}

\begin{equation}
    V_m = 375\,\text{V}\times\sqrt{2} = 530\,\text{V}
\end{equation}
...
\begin{equation}
    V_{DC} = \frac{1}{\pi/3\,\text{rad}}\int_{-\pi/6\,\text{rad}}^{\pi/6\,\text{rad}} 530\,\text{V}\cos\theta\,d\theta
    = \frac{3(530\,\text{V})}{\pi}\left[\sin\frac{\pi}{6}-\sin\left(-\frac{\pi}{6}\right)\right]
\end{equation}

\begin{equation}
    \boxed{V_{DC} = 506\,\text{V}}
\end{equation}

\begin{equation}
    I_{DC} = \frac{506\,\text{V}}{96{,}0\,\Omega} = \boxed{5{,}28\,\text{A}}
\end{equation}
...
Con la amplitud del armónico 6 obtenida por integración de $530\cos\theta\cos(6\theta)$
...
\begin{equation}
    V_{rms} = \boxed{506{,}8\,\text{V}}, \qquad I_{rms} = \boxed{5{,}28\,\text{A}}
\end{equation}

\begin{equation}
    I_L = I_{DC}\sqrt{2/3} = 5{,}28\,\text{A}\,(0{,}8165) = \boxed{4{,}31\,\text{A}}
\end{equation}

\begin{equation}
    I_{D,DC} = \frac{I_{DC}}{\sqrt3} = \frac{5{,}28\,\text{A}}{1{,}732} = \boxed{3{,}05\,\text{A}},
    \qquad I_{D,rms} = \boxed{3{,}05\,\text{A}}
\end{equation}

\textbf{Potencia, factor de potencia, eficiencia, factores de rizado:}
\begin{equation}
    P = I_{rms}^2 R = (5{,}28\,\text{A})^2(96{,}0\,\Omega) = \boxed{2675\,\text{W}}
\end{equation}

\begin{equation}
    S = \sqrt3\,V_f\,I_L = \sqrt3\,(375\,\text{V})(4{,}31\,\text{A}) = \boxed{2798\,\text{VA}}
\end{equation}

\begin{equation}
    fp = \frac{2675\,\text{W}}{2798\,\text{VA}} = \boxed{0{,}956}
\end{equation}

\begin{equation}
    \eta = \frac{P_{DC}}{S} = \frac{2672\,\text{W}}{2798\,\text{VA}} = \boxed{0{,}955}
\end{equation}

\begin{equation}
    FR_V = \frac{20{,}5\,\text{V}}{506\,\text{V}} = \boxed{0{,}0404}, \qquad
    FR_I = \frac{0{,}191\,\text{A}}{5{,}28\,\text{A}} = \boxed{0{,}0362}
\end{equation}

\textbf{Especificaciones del puente rectificador:} cada diodo debe soportar una
tensión inversa de pico $PIV = V_m = 530\,\text{V}$ y una corriente eficaz
$I_{D,rms}=3{,}05\,\text{A}$; se recomiendan diodos de $\geq 800\,\text{V}$ y
$\geq 6\,\text{A}$ (margen de seguridad $\sim$1,5$\times$).
...
El enunciado fija $V_L=611\,\text{V}\sin(100\pi t)$ (tensión de fase pico) para
todos los estudiantes, independiente de $a,b,c$; dado que el ejercicio no
especifica $R$ ni $L$, se reutilizan los valores del Ejercicio 1
($R=96{,}0\,\Omega$, $L=21{,}0\,\text{mH}$).

\textbf{Datos:} $V_m=611\,\text{V}$, $\omega=100\pi\,\text{rad/s}\Rightarrow f=50{,}0\,\text{Hz}$,
$R=96{,}0\,\Omega$, $L=21{,}0\,\text{mH}$.
...
\begin{equation}
    a_0 = V_{DC} = \frac{1}{2\pi/3\,\text{rad}}\int_{-\pi/3\,\text{rad}}^{\pi/3\,\text{rad}} 611\,\text{V}\cos\theta\,d\theta
    = \frac{3(611\,\text{V})}{2\pi}\left[\sin\frac{\pi}{3}-\sin\left(-\frac{\pi}{3}\right)\right]
\end{equation}

\begin{equation}
    \boxed{V_{DC} = 505\,\text{V}}
\end{equation}

\begin{equation}
    I_{DC} = \frac{505\,\text{V}}{96{,}0\,\Omega} = \boxed{5{,}26\,\text{A}}
\end{equation}

\textbf{Armónico $n=1$ ($m=6$, $f_6=300\,\text{Hz}$):}
\begin{equation}
    a_6 = \frac{2}{2\pi/3\,\text{rad}}\int_{-\pi/3\,\text{rad}}^{\pi/3\,\text{rad}} 611\,\text{V}\cos\theta\cos(6\theta)\,d\theta,
    \qquad b_6 = 0\,\text{V}
\end{equation}
...
\begin{equation}
    v_o(t) = \underbrace{505\,\text{V}}_{DC} + \underbrace{a_6\cos(1885\,\text{rad/s}\cdot t)}_{AC} + \cdots
\end{equation}
\begin{equation}
    i_o(t) = \underbrace{5{,}26\,\text{A}}_{DC} + \underbrace{|I_6|\cos(1885\,\text{rad/s}\cdot t - \angle Z_6)}_{AC} + \cdots
\end{equation}

\textbf{RMS, potencias y factores de calidad:}
\begin{equation}
    V_{rms} = \boxed{505{,}7\,\text{V}}, \qquad I_{rms} = \boxed{5{,}27\,\text{A}}
\end{equation}

\begin{equation}
    I_L = I_D = \frac{I_{DC}}{\sqrt3} = \frac{5{,}26\,\text{A}}{1{,}732} = \boxed{3{,}04\,\text{A}}
\end{equation}

\begin{equation}
    P = I_{rms}^2R = (5{,}27\,\text{A})^2(96{,}0\,\Omega) = \boxed{2663\,\text{W}}
\end{equation}

\begin{equation}
    V_L = \sqrt3\,V_f = \sqrt3(432\,\text{V}) = 748\,\text{V}, \qquad
    S = \sqrt3\,V_L\,I_L = \sqrt3(748\,\text{V})(3{,}04\,\text{A}) = \boxed{3939\,\text{VA}}
\end{equation}

\begin{equation}
    fp = \frac{2663\,\text{W}}{3939\,\text{VA}} = \boxed{0{,}676}, \qquad
    \eta = \frac{P_{DC}}{S} = \frac{2660\,\text{W}}{3939\,\text{VA}} = \boxed{0{,}675}
\end{equation}
...
media onda con $V_m=611\,\text{V}$, $f=50{,}0\,\text{Hz}$, $R=96{,}0\,\Omega$,
